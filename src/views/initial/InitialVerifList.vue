...
export default {
  ...
  data () {
    return {
      ...
      fields: [
        ...
        {key: 'fte_status', label: 'FTE Status', sortable: true},
        {key: 'verif_status', label: 'Verification Status', sortable: true},
  ...
  methods: {
    ...
    viewResearch(r, i, e) {
      ...
      this.$router.push("initial-verif-view")
      // TODO, redirect to view detail
    },
    editData () {
      this.$router.push("initial-verif-edit")
    }
  },
  mounted() {
